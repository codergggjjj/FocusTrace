...
class AppContainer(context: Context) {
    val database = Room.databaseBuilder(context.applicationContext, FocusTraceDatabase::class.java, "focustrace.db")
        .addMigrations(FocusTraceDatabase.Migration1To2, FocusTraceDatabase.Migration2To3, FocusTraceDatabase.Migration3To4).addCallback(FocusTraceDatabase.SeedCategories).build()
